Public Class WindowTest
    ...
    Private Sub Window_Test_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Console.Write("(fluoflex) : Openned test Window")
    End Sub
    Private Sub Window_Test_MouseMove(ByVal sender As Object,
...
Handles MyBase.MouseMove
        ...
        End If
    End Sub
    Private Sub Window_Test_MouseDown(ByVal sender As Object,
    ByVal e As System.Windows.Forms.MouseEventArgs) _
