...
goto EnterCmd
:swferr
echo %prg%: cat: No file with the specified name
goto EnterCmd
:swft
set filename=
set /p filename=Filename: %rdir%\
...
goto EnterCmd
:mkdirrmdirerr
echo On "%input%", directory name is invalid. Use just "rd" or "md" and after enter the name if you don't wan't that.
goto EnterCmd
:rmdir
if "%ro%"=="1" goto roatrib
if "%input%"=="rd" goto rmdirt
...
echo  -  Improve HELP, PRGLIST and CHANGES command for little screens. More clean required!
echo  -  Add user management system, with users, personnals directorys and passwords!
echo  -  Improve error messages.
echo     For exemple: This file allready exists! Use EDF to edit this or Try another name...
echo                  Will be
...
echo  -  Updated NaDB
echo.
echo New on Natbuntu 3.3 Lucid Lynx (LTS)
echo  -  Bug fixes
